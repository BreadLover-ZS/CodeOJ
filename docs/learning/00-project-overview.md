...
这份文档帮你先看懂模块如何协作、一次提交会发生什么，以及几个容易混淆的状态。读完后，再按[源码阅读路径](01-source-reading-paths-and-tests.md)逐段追代码；这里不展开故障分析和面试回答。
...
读到这里，应能说清每个模块的职责、一次提交的走向，以及任务状态与判题结论的区别。接下来从[一次 Java 提交如何完成判题](01-source-reading-paths-and-tests.md#2-路径一一次-java-提交如何完成判题)开始，沿源码核对这些概念。
...
[sandbox-interface]: ../../codeoj-backend/codeoj-backend-judge-service/src/main/java/com/codeoj/codeojbackendjudgeservice/judge/codesandbox/CodeSandbox.java
[sandbox-factory]: ../../codeoj-backend/codeoj-backend-judge-service/src/main/java/com/codeoj/codeojbackendjudgeservice/judge/codesandbox/CodeSandboxFactory.java
[sandbox-proxy]: ../../codeoj-backend/codeoj-backend-judge-service/src/main/java/com/codeoj/codeojbackendjudgeservice/judge/codesandbox/CodeSandboxProxy.java
[judge-strategy]: ../../codeoj-backend/codeoj-backend-judge-service/src/main/java/com/codeoj/codeojbackendjudgeservice/judge/strategy/JudgeStrategy.java
